...
const DetailedVila = () => {
    ...
    return (
      ...
      <section className='w-full  mb-[8rem] mt-[5rem]'>
        <article className='w-[80%] mx-auto flex gap-10 '>
          <aside className='w-[70%]'>
              <section className='w-full h-[600px]'>
                  <VCrousel/>
              </section>
              <section className='w-full h-auto rounded-[6.1px] shadow-[0_7.6px_38px_0_rgba(0,0,0,0.07)]'>
              <article className="flex flex-col justify-between gap-4 p-10 mt-20">
                    ...
                    <footer className="flex justify-between text-sm w-[60%]">
              ...
              <section className='w-full bg-[#f4f4f4] h-15'>
              <section className=' flex justify-between items-center w-[80%] ml-10   mt-15'>
              <h1 
